...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE = "create table " + TABLE_NEWS + "( " + _ID + " integer auto_increment primary key , " + TITLE + " text not null Unique, " + LINK_MORE + " text Unique," + PUBDATE + " timestamp default current_timestamp," + DESCRIPTION + " text not null Unique," + CATEGORY + " text not null," + LINK_IMAGE + " text not null Unique," + RELATED_LINK + " text Unique);";
